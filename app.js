...
// action to be performed when player click on 'Roll Dice' btn
document.querySelector('.btn-roll').addEventListener('click', function() {
    
    if (gamePlaying) {
        // 1. random integer between 1-6
...
// action to be performed when player click on 'Hold' btn
...
// action to be performed when player click on 'New Game' btn
